(function (angular) {
    ...
    angular.module("emr.common.queryAdapter", [])

    .service("queryAdapter", ["emr.common.pagination.helper",
        "emr.common.ordering.helper", "emr.common.filtering.helper",
        "emr.common.search.helper", "emr.common.get.params",
        "emr.common.partial.response.service", "emr.common.adapter.utils",
