(function (angular, _) {
    ...
    angular.module("dbcheck.common.adapter.utils", [])
     ...
     */
    .service("dbcheck.common.adapter.utils",
        ["PAGINATION_COUNT", function (page_count) {
            ...
            var getEmptyParamsObj = function () {
                return {
                    fields: [],
                    filtering: {},  // search is under filtering
                    ordering: [],
                    page: 1,
             ...
             *
             * @param  {[Array]} arr containing filter_params as simple
             * ``String``s or as objects
            ...
            var convertStringToProperCase = function (arr) {
                ...
                if (_.isUndefined(arr)) {
                    ...
                    _.each(arr, function (returnedItem) {
                        ...
                        // are objects
                        // For cases where the items are simple strings a
                        // different check
