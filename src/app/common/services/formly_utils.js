(function (angular) {
    ...
    angular.module("dbcheck.common.formlyUtils", [
        "formly",
        "formlyBootstrap",
        "ui.bootstrap"
    ])

    .service("dbcheck.common.formly.formlyConfig",
        ["formlyConfig", function (formlyConfig) {
            ...
            var setType = function () {
                formlyConfig.setType([
                    {
                        controller: "dbcheck.common.datetimepicker",
                        name: "datetimepicker",
                        templateUrl:"common/tpls/datetimepicker.tpl.html",
                        wrapper: ["bootstrapLabel", "bootstrapHasError"]
                    },
                    {
                        controller: "dbcheck.common.datepicker",
                        name: "datepicker",
                        templateUrl:"common/tpls/datepicker.tpl.html",
                        wrapper: ["bootstrapLabel", "bootstrapHasError"]
                    },
                    {
                        controller: "dbcheck.common.timepicker",
                        name: "timepicker",
                    ...
                    // repeating section
                    {
                        controller: "dbcheck.formly.repeatingSection",
                        name: "repeatSection",
