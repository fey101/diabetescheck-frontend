(function (angular) {
    ...
    angular.module("dbcheck.common.utilities.jsDataUtils",[
        "dbcheck.config",
        "dbcheck.auth.services",
        "dbcheck.common.adapter.utils" //registered under common.services
    ])

    .factory("dbcheck.resource.metadataCache", [
        "dbcheck.common.adapter.utils", function (utils) {
            /**
             ...
             */
            var cache = {};  // This cache could easily be persistent
