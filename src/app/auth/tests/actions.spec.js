(function () {
    ...
    describe("Testing actions module :", function () {
        beforeEach(module("emr.actions"));
        beforeEach(module("emr.common.services.query_adapter"));
        beforeEach(module("emrApp.constants"));
        ...
        it("should define canPerform function", function () {
            inject(["emr.actions.actionChecker", function (ac) {
                expect(angular.isFunction(ac.canPerform)).toBe(true);
            }]);
        });

        it("should define hasAction function", function () {
            inject(["emr.actions.hasAction", function (ac) {
                expect(angular.isFunction(ac.hasActions)).toBe(true);
            }]);
        });

        describe("Testing emr.actions.actionChecker restrictions not defined:",
            function () {
        ...
        describe("Testing emr.actions.actionChecker restrictions defined:",
            function () {
        ...
        describe("Testing emr.actions.actionChecker fail :", function () {
            beforeEach(function () {
            ...
            it("should raise error if actionChecker is" +
                ...
                inject(["$injector", function ($injector) {
                    var fxn = function () {
                        $injector.get("emr.actions.actionChecker");
                    };
                    expect(fxn).toThrow(new Error(
                        "[emr.actions:actionChecker] ImproperlyConfigured : " +
        ...
        describe("Testing emr.actions.hasAction checkers not defined :",
            function () {
        ...
        describe("Testing emr.actions.pageChecker checkers not defined :",
            function () {
                ...
                it("should return true if checkers not defined", function () {
                    ...
                    inject(["emr.actions.pageChecker", function (pc) {
        ...
        describe("Testing emr.actions.hasAction checkers defined :",
            function () {
        ...
        describe("Testing emr.actions.pageChecker checkers defined :",
            function () {
                ...
                it("should return true for page checkers search", function () {
                    ...
                    a_check = true;
                    b_check = true;
                    inject(["emr.actions.pageChecker", function (ac) {
        ...
        describe("Testing emr.actions.hasAction fail :", function () {
            beforeEach(function () {
            ...
            it("should raise if improperly configured", function () {
                inject(["$injector", function ($injector) {
                    var fxn = function () {
                        $injector.get("emr.actions.hasAction");
                    };
                    expect(fxn).toThrow(new Error(
                        "[emr.actions:hasAction] ImproperlyConfigured : " +
                        "ACTIONS.CHECKERS " +
                        "should be an array"
                        )
                    );
        ...
        describe("Testing emr.actions.pageChecker fail :", function () {
            beforeEach(function () {
            ...
            it("should raise if improperly configured", function () {
                inject(["$injector", function ($injector) {
                    var fxn = function () {
                        $injector.get("emr.actions.pageChecker");
                    };
                    expect(fxn).toThrow(new Error(
                        "[emr.actions:pageChecker] ImproperlyConfigured :" +
                        " PAGE.CHECKERS " +
                        "should be an array"
                        )
                    );
        ...
        describe("Testing emr.actions.pageActions", function () {
            var hasAction, state;
            beforeEach(function () {
                module("ui.router");
                module("emr.common");
                inject(["emr.actions.hasAction","$state", function (ha, $state) {
                    hasAction = ha;
                    state = $state;
                }]);
            });
            ...
            it("should allow with defined actions", function () {
                ...
                inject(["emr.actions.pageActions", function (pa) {
                    var params = {
                        actions: "hehe"
                    };
            ...
            it("test checkFailed", function () {
                spyOn(state, "go");
                inject(["emr.actions.pageActions", function (fail) {
                    fail.checkFailed();
        ...
        describe("Testing actions directive :", function () {
            ...
            it("should compile", function () {
                var element = angular.element(
                    "<div id='r'><p emr-app-actions='nav.visits'>asd</p></div>"
                );
            ...
            it("should not do anything without actions", function () {
                var element = angular.element(
                    "<div id='r'><p emr-app-actions=''>asd</p></div>"
                );
                compile(element)(rootscope);
                var test = angular.element(angular.element(element.html()));
                expect(angular.element(test[1]).html()).toEqual("asd");
            ...
            it("should remove element", function () {
                inject(["emr.actions.hasAction", function (hasAction) {
                    spyOn(hasAction, "hasActions").and.returnValue(false);
                    var tags = ["emr-app-actions", "x-emr-app-actions",
                        "data-emr-app-actions"];
        ...
        describe("Testing emr.actions.pageChecker listeners :", function () {
            var rootScope;
        ...
        describe("Test emr.actions.hasAction", function () {
            ...
            beforeEach(function () {
                ...
                inject(["APP_ACTION_CHECKERS", "$injector",
                    "emr.actions.hasAction", "emr.actions.actionChecker",
