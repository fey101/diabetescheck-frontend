...
describe("Test auth login service: ", function () {
    ...
    inject(["emr.auth.services.login", function (loginService) {
    ...
    inject(["api.oauth2", "emr.auth.services.login",
    ...
    it("should post a user email to the server", function () {
        inject(["$httpBackend","emr.auth.services.login",
    ...
    inject(["emr.auth.services.login", "api.oauth2", "$window",
    ...
    inject(["emr.auth.services.login", "api.oauth2",
    ...
    inject(["emr.auth.services.login", "$window",
    ...
    inject(["emr.auth.services.login", "$window", "api.oauth2",
