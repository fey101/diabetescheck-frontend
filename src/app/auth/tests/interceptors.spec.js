(function (angular) {
    ...
    describe("Test networking.interceptors :", function () {
        ...
        beforeEach(module("emr.networking.interceptors"));
        ...
        describe("test httpactivity interceptor :", function () {
            ...
            it("should define functions", function () {
                inject(["emr.networking.interceptors.httpactivity",
                    function (ha) {
        ...
        describe("test http interceptor :", function () {
            ...
            it("should define functions", function () {
                inject(["emr.networking.interceptors.http", function (ht) {
        ...
        describe("test connection interceptor :", function () {
            it("should define functions", function () {
                inject(["emr.networking.interceptors.connection",
                    function (co) {
