(function () {
    ...
    describe("Testing authorization module :", function () {
        ...
        beforeEach(module("emr.authorization"));
        beforeEach(module("emr.common.services.query_adapter"));
        beforeEach(module("emr.auth.services"));
        ...
        describe("test authorization.loggedin :", function () {
            ...
            beforeEach(
                inject(["emr.auth.services.login", function(ac) {
                    authConfig = ac;
                }])
            );
            ...
            it("should grant access on a successfull login attempts", function () {
                ...
                inject(["emr.authorization.loggedin", function(li) {
            ...
            describe("with user details :", function () {
                beforeEach(
                    module(["$provide", function(p) {
                        p.value("emr.auth.services.login", {
                            getUser : function() {
                                return {
                                    actions: [
                                        {"actions__name": "eat"},
                ...
                it("should grant access", function () {
                    inject(["emr.authorization.hasPerm", function(hp) {
        ...
        describe("test authorization.actionChecker :", function () {
            ...
            beforeEach(function () {
                inject(["$injector", "emr.authorization.hasPerm",
                    function (ij, ia, hp) {
                        injector = ij;
                        hasPerm = hp;
                    }
            ...
            it("should define functions", function () {
                inject(["emr.authorization.actionChecker", function(ac) {
            ...
            it("should complain if an action is not found", function () {
                ...
                inject(["emr.authorization.actionChecker", function (ac) {
                    ...
                    expect(fxn).toThrow(new Error(
                        "[emr.authorization:actionChecker.badaction]" +
            ...
            it("should complain if an action permission is not a string",
                function () {
                    ...
                    inject(["emr.authorization.actionChecker", function (ac) {
                        ...
                        expect(fxn).toThrow(
                            new Error(
                                "[emr.authorization:actionChecker.badperm]" +
                                " ImproperlyConfigured : " +
